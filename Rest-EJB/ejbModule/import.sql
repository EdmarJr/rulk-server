...
insert into unidade (ativo,nome,empresa_id) values ('false','Unidade Teste',1);
insert into usuario(email,cpf,unidade_id) values ('teste@gmail.com','75394073104',1);
insert into usuario (email,nome,cpf,foto,hashSenha,unidade_id)values ('edmarfagunde@gmail.com','Edmar','75394073104',NULL,'123456',1);
